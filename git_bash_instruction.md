...
### 15.2. Добавление удалённых репозиториев
 ...
 ### 15.3. Получение изменений из уда`ённого репозитория
 ...
 * Cоздать аккаунт, например на GitHub.com.
